...
class Feeding(models.Model):
    ...
    article   = models.ForeignKey(Article, on_delete=models.CASCADE, related_name="feeding", verbose_name="Article Entrant")
    qté       = models.DecimalField(max_digits=12, decimal_places=2, verbose_name="Quantité Entrée")
    prix      = models.DecimalField(max_digits=12, decimal_places=2, null=True, verbose_name="Prix Unitiare")
